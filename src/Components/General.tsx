...
const CommonFuncUICard = ({ name }: ComponentsGeneralProps) => {
        ...
        <div className="min-h-screen bg-gray-900 flex justify-center items-center p-6">
            <div className="bg-white mb-20 p-6 rounded-2xl shadow-lg w-full max-w-4xl">
                ...
                <div className="mt-6 flex justify-center">
                    <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded flex items-center text-lg">
                        &#9654; Run Algorithm
                    </button>
                </div>
            </div>
...
//                 <div className="flex justify-between items-center mb-6">
//                     <h2 className="text-3xl font-bold font-serif">{name}</h2>
//                     <button onClick={handleBackToAlgorithm} className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded flex items-center">
//                         <span className="mr-2">&lt;/&gt;</span>
//                         <span>Back</span>
//                     </button>

//                     <button onClick={handleViewSource} className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded flex items-center">
//                         <span className="mr-2">&lt;/&gt;</span>
//                         <span>View Source</span>
//                     </button>
//                 </div>
...
//                 <div className="overflow-x-auto whitespace-nowrap flex flex-wrap gap-2 p-2  rounded-lg">
//                     {array.map((num, index) => (
//                         <div key={index} className="bg-blue-200 text-blue-700 font-bold py-2 px-4 rounded">{num}</div>
//                     ))}
//                 </div>
//                 <div className="mt-6 flex justify-center">
//                     <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded flex items-center text-lg">
